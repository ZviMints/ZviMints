...
## Metrics
![Metrics](https://metrics.lecoq.io/ZviMints?template=classic&stackoverflow=1&gists=1&lines=1&isocalendar=1&isocalendar.duration=half-year&stackoverflow.user=10875851&stackoverflow.sections=answers-top%2C%20questions-recent&stackoverflow.limit=2&stackoverflow.lines=4&stackoverflow.lines.snippet=2&config.timezone=Asia%2FJerusalem)
